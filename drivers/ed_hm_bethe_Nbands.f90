program hm_Nbands_bethe
  ...
  call parse_input_variable(betheSC,"BETHESC",finput,default=.true.)
  ...
  if(master)call dmft_print_gf_matsubara(Gmats,"G0loc",iprint=1)
  if(master)call dmft_print_gf_realaxis(Greal,"G0real",iprint=1)
