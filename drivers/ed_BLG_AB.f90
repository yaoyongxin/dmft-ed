  ...
  real(8),dimension(2)                          :: pointM,pointK,pointKp,pointY
...
contains
  ...
  subroutine build_hk(file)
    ...
    write(LOGfile,*)"Build H(k) of AB Bilayer Graphene:",Lk
    ...
    if(present(file))then
       call TB_write_hk(Hk,"Hkrfile_BLG_AB.data",&
            No=Nlso,&
            Nd=Norb,&
            Np=0,&
            Nineq=1,&
